    ...
    <section id="projects" className="px-6 py-20 md:py-28">
      <div className="mx-auto max-w-6xl">
        <div className="mb-12 max-w-2xl">
          <p className="font-display text-sm font-medium text-primary">Projects</p>
          <h2 className="mt-2 font-display text-3xl font-bold tracking-tight text-foreground md:text-4xl">
            Featured work
          </h2>
          <p className="mt-4 text-base leading-relaxed text-muted-foreground">
            Click any project to see the problem it solved, how I built it, and the result.
          </p>
        </div>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <article
            ...
            className="card-hover flex cursor-pointer flex-col overflow-hidden rounded-2xl border border-border bg-card focus:outline-none focus-visible:ring-2 focus-visible:ring-ring">
              ...
              <div className="flex flex-1 flex-col p-6">
                ...
                <span className="mt-6 text-sm font-medium text-primary">View details</span>
              </div>
            </article>
          )}
        </div>
